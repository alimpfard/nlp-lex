...
public:
    ...
    template<typename T>
    void emitLocation(T* node, llvm::IRBuilder<>& builder)
    {
        llvm::DIScope* Scope;
        if (LexicalDebugBlocks.empty())
            Scope = TheCU;
    ...
    llvm::DIType* getInputStructDiType()
    {
        ...
        llvm::DIType* i8 = DBuilder->createBasicType("char", 8, llvm::dwarf::DW_ATE_signed_char);
        llvm::DIType* i32 = DBuilder->createBasicType("int", 32, llvm::dwarf::DW_ATE_signed);
    ...
    MainScope mkscope()
    {
        ...
        llvm::FunctionType* ncf = llvm::FunctionType::get(llvm::Type::getVoidTy(TheContext), args, false);
    ...
    auto createGlobal(llvm::Type* type, llvm::Constant* value, std::string name,
        bool dexport = false)
    {
        auto res = new llvm::GlobalVariable(type, false,
        ...
        , outputv(os)
    {
        ...
        static llvm::StringRef mDeserBitcode = llvm::StringRef((const char*)deser_inc_bc, deser_inc_bc_len);
        ...
        llvm::FunctionType* ncf = llvm::FunctionType::get(llvm::Type::getInt8Ty(TheContext), {}, false);

        nlex_current_f = llvm::Function::Create(ncf, llvm::Function::InternalLinkage,
            "__nlex_current", TheModule.get());
        llvm::FunctionType* ucf = llvm::FunctionType::get(llvm::Type::getInt32Ty(TheContext),
            { llvm::Type::getInt8Ty(TheContext) }, false);

        nlex_get_utf8_length = llvm::Function::Create(ucf, llvm::Function::ExternalLinkage,
            "__nlex_utf8_length", TheModule.get());

        llvm::FunctionType* nln = llvm::FunctionType::get(llvm::Type::getVoidTy(TheContext), {}, false);
        ...
        llvm::FunctionType* nrs = llvm::FunctionType::get(llvm::Type::getVoidTy(TheContext), args, false);
        ...
        nlex_current_p = llvm::Function::Create(ncp, llvm::Function::InternalLinkage,
        ...
        llvm::FunctionType* nc = llvm::FunctionType::get(llvm::Type::getInt64Ty(TheContext), {}, false);
...
public:
    ...
    std::array<llvm::BasicBlock*, 2> create_backtrack_block(llvm::Function* fn)
    {
        ...
        auto backtrackBB = llvm::BasicBlock::Create(module.TheContext, "_backtrack", fn);
        ...
        auto backtrackExitBB = llvm::BasicBlock::Create(module.TheContext, "_backtrack_exit", fn);
        ...
        bool skip_on_error = true)
    {
        ...
        auto BBfinalise = llvm::BasicBlock::Create(module.TheContext, "_escape_top", fn);
        ...
        if (skip_on_error) {
            auto advance_and_callFbb = llvm::BasicBlock::Create(module.TheContext, "_escape_redo", fn);
        ...
        module.Builder.CreateStore(
            errc, module.Builder.CreateInBoundsGEP(istruct, {
                                                                llvm::ConstantInt::get(llvm::Type::getInt32Ty(module.TheContext), 0),
        ...
        if (cleanup_if_fail) {
            ...
            module.Builder.CreateCondBr(
                module.Builder.CreateICmpEQ(
                    errc, llvm::ConstantInt::get(llvm::Type::getInt8Ty(module.TheContext), 0)),
                ebb, mbb);
    ...
    void prepare(const GenLexer&& lexer_stuff)
    {
        ...
        if (get(lexer_stuff.options, "capturing_groups")) {
            ...
            auto arrty = llvm::ArrayType::get(llvm::Type::getInt8PtrTy(module.TheContext),
                (lexer_stuff.total_capturing_groups + 1) * 2);
            module.nlex_capture_indices = module.createGlobal(arrty, llvm::ConstantArray::getNullValue(arrty),
            ...
            auto total_groups = llvm::ConstantInt::get(llvm::Type::getInt32Ty(module.TheContext),
            ...
            // get start ptr
            {
                ...
                auto arg = builder.CreateFPToSI(module.nlex_get_group_start_ptr->arg_begin(),
                    llvm::Type::getInt32Ty(module.TheContext));
                ...
                llvm::PHINode* phi = builder.CreatePHI(llvm::Type::getInt8PtrTy(module.TheContext), 2);
            ...
            // get end ptr
            {
                ...
                builder.SetInsertPoint(bb0);
                auto arg = builder.CreateFPToSI(module.nlex_get_group_end_ptr->arg_begin(),
                    llvm::Type::getInt32Ty(module.TheContext));
                builder.CreateCondBr(builder.CreateICmpSGT(arg, total_groups), bb2,
                    bb1);
                builder.SetInsertPoint(bb1);
            ...
            // get length
            {
                ...
                builder.SetInsertPoint(bb0);
                auto arg = builder.CreateFPToSI(module.nlex_get_group_length->arg_begin(),
                    llvm::Type::getInt32Ty(module.TheContext));
                builder.CreateCondBr(builder.CreateICmpSGT(arg, total_groups), bb2,
                    bb1);
                builder.SetInsertPoint(bb1);
                    ...
                    builder.CreateInBoundsGEP(
                        ...
                        { llvm::ConstantInt::get(
                            ...
                            builder.CreateSExt(
                                ...
                                llvm::Type::getInt64Ty(module.TheContext)) }),
                    llvm::Type::getInt64PtrTy(module.TheContext)));
                auto phiout0 = builder.CreateTrunc(builder.CreateSub(a1, a0),
                    llvm::Type::getInt32Ty(module.TheContext));
                builder.CreateBr(bb2);
                builder.SetInsertPoint(bb2);
                llvm::PHINode* phi = builder.CreatePHI(llvm::Type::getInt32Ty(module.TheContext), 2);
                phi->addIncoming(llvm::Constant::getNullValue(
                                     llvm::Type::getInt32Ty(module.TheContext)),
                    bb0);
                phi->addIncoming(phiout0, bb1);
        ...
        // crucial library functions
        {
            ...
            auto nlex_true_start = module.createGlobal(
                ...
                llvm::Constant::getNullValue(llvm::PointerType::get(
                    llvm::Type::getInt8Ty(module.TheContext), 0)),
                "nlex_true_start");
            auto nlex_tmp_char = module.createGlobal(llvm::Type::getInt8Ty(module.TheContext),
                llvm::Constant::getNullValue(
            ...
            auto nlex_injected = module.createGlobal(
                ...
                llvm::Constant::getNullValue(llvm::PointerType::get(
                    llvm::Type::getInt8Ty(module.TheContext), 0)),
                "nlex_injected");
            auto nlex_injected_length = module.createGlobal(llvm::Type::getInt32Ty(module.TheContext),
                llvm::Constant::getNullValue(
                    llvm::Type::getInt32Ty(module.TheContext)),
                "nlex_injected_length");
            auto nlex_injected_length_diff = module.createGlobal(llvm::Type::getInt32Ty(module.TheContext),
                llvm::Constant::getNullValue(
                    llvm::Type::getInt32Ty(module.TheContext)),
            ...
            BB = llvm::BasicBlock::Create(module.TheContext, "", module.nlex_distance);
            builder.SetInsertPoint(BB);
            ...
            builder.CreateCondBr(
                builder.CreateICmpSGT(
                    len, llvm::ConstantInt::get(llvm::Type::getInt32Ty(module.TheContext), 0)),
                uBB, pBB);
            // inject
            builder.SetInsertPoint(uBB);
            builder.CreateStore(
                builder.CreateNSWSub(
                    len, llvm::ConstantInt::get(llvm::Type::getInt32Ty(module.TheContext), 1)),
                nlex_injected_length);
            ...
            auto gep = builder.CreateInBoundsGEP(
                fs, { llvm::ConstantInt::get(llvm::Type::getInt32Ty(module.TheContext), 1) });
                        ...
                        if (!levels.count(norm.substr(0, i))) {
                            ...
                            if (i == norm.size()) {
                                ...
                                auto gep = mbuilder.CreateInBoundsGEP(
                                    fs, { llvm::ConstantInt::get(llvm::Type::getInt32Ty(module.TheContext), i) });
            ...
            auto icmp = builder.CreateICmpULT(
                arg, llvm::ConstantInt::get(llvm::Type::getInt8Ty(module.TheContext), 127));
            builder.CreateCondBr(icmp, _11, _4);
            builder.SetInsertPoint(_4);
            auto icmp_4 = builder.CreateICmpULT(
                arg, llvm::ConstantInt::get(llvm::Type::getInt8Ty(module.TheContext), -33));
            builder.CreateCondBr(icmp_4, _11, _6);
            builder.SetInsertPoint(_6);
            auto icmp_6 = builder.CreateICmpULT(
                arg, llvm::ConstantInt::get(llvm::Type::getInt8Ty(module.TheContext), -17));
        ...
        if (lexer_stuff.stopwords.size() > 0) {
            auto isstopword = module.createGlobal(llvm::Type::getInt1Ty(module.TheContext),
            ...
            while (!qnodes.empty()) {
                ...
                qnodes.pop();
                auto nfbb = llvm::BasicBlock::Create(module.TheContext, "", module.main());
        ...
        if (get(lexer_stuff.options, "pure_normaliser")) {
            ...
            auto entry = llvm::BasicBlock::Create(module.TheContext, "", pure_normalise);
        ...
        if (lexer_stuff.literal_tags.size() > 0) {
            ...
            llvm::BasicBlock* start = llvm::BasicBlock::Create(module.TheContext, "start", module.main());
            module.start = start;
        ...
        // emit pos tagger stuff if that's specified
        {
            ...
            module.createGlobal(
                llvm::PointerType::get(llvm::Type::getInt8Ty(module.TheContext), 0),
                (llvm::Constant*)(lexer_stuff.tagpos.has_value()
    ...
    void end(const GenLexer& lexer_stuff)
    {
        ...
        if (targetTriple.library && targetTriple.triple.getOSName() == "windows") {
            ...
            llvm::Function* x_dll = llvm::Function::Create(
                llvm::FunctionType::get(llvm::Type::getInt1Ty(module.TheContext),
                    false),
            ...
            Builder.SetInsertPoint(bb);
            Builder.CreateRet(llvm::ConstantInt::getTrue(module.TheContext));
        }
        ...
        if (!targetTriple._write_ll) {
            ...
            if (targetTriple.library && targetTriple.triple.getOSName() == "windows") {
                ...
                for (const auto& glob : Composite->globals())
                    if (glob.getLinkage() == llvm::GlobalValue::LinkageTypes::ExternalLinkage)
                        def_dest << "\t" << glob.getName() << "\n";
                for (const auto& fun : Composite->functions())
                    if (fun.getLinkage() == llvm::GlobalValue::LinkageTypes::ExternalLinkage && !fun.isIntrinsic())
                        def_dest << "\t" << fun.getName() << "\n";

                slts.show(Display::Type::MUST_SHOW,
                    "also generated a module-definition file "
                    "{<magenta>}%s{<clean>}, use it to export functions for the "
                    "dll:\n\tlink.exe /dll /nodefaultlib /noentry /def:%s %s",
    ...
    {
        llvm::ArrayType* Ty = llvm::ArrayType::get(llvm::Type::getInt8Ty(Context), svalue.size() + 1);
        ...
        std::string name = "str")
    {
        ...
        return registered_tags[tag] = mk_string(module.TheModule.get(), module.TheContext, tag);
    }
    llvm::ConstantInt* get_or_create_tag_constint(std::string tag)
    {
        ...
        if (registered_tags.count(tag))
            ...
            s = registered_tags[tag] = mk_string(module.TheModule.get(), module.TheContext, tag);
        return to_int(s);
    }
